...
public class PetService extends AbstractCrudService<Object> {
    ...
    public Mono<Map<String, Object>> listPetsByContact(Map<String, Object> arguments) {
        try {
            ...
            String endpoint = "/contacts/" + contactId + "/pets";
            ...
            return monicaClient.get(endpoint, queryParams)
                ...
                .doOnSuccess(result -> log.info("Pets for contact {} listed successfully", contactId))
                .doOnError(error -> log.error("Failed to list pets for contact {}: {}", contactId, error.getMessage()));

...
public class NoteService extends AbstractCrudService<Object> {
    ...
    public Mono<Map<String, Object>> listNotesByContact(Map<String, Object> arguments) {
        try {
            ...
            String endpoint = "/contacts/" + contactId + "/notes";
            ...
            return monicaClient.get(endpoint, queryParams)
                ...
                .doOnSuccess(result -> log.info("Notes for contact {} listed successfully", contactId))
                .doOnError(error -> log.error("Failed to list notes for contact {}: {}", contactId, error.getMessage()));

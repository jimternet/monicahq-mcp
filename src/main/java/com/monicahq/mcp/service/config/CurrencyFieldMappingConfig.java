...
/**
 * Field mapping configuration for Currency entities.
 * <p>
 * Defines the field mappings and API endpoint for Currency operations.
 * Currency entities are read-only lookup values used for monetary amounts.
 * </p>
 * <p>
 * Field mappings:
 * <ul>
 *   <li>exchangeRate (client) -> exchange_rate (API)</li>
 * </ul>
 * </p>
 * <p>
 ...
 */
@Component
public class CurrencyFieldMappingConfig implements FieldMappingConfig {

    private static final String ENDPOINT_PATH = "/currencies";
    ...
    /**
     * List filter fields - search can be used to filter currencies.
     */
    ...
    /**
     * Currency entities are read-only lookup values.

...
/**
 * Contract test for debt_list_by_contact MCP operation.
 * Tests listing debts filtered by contact ID.
...
public class DebtListByContactTest {
    ...
    @Test
    void shouldListDebtsByContactViaMcpProtocol() {
        // Given: MCP request to list debts for a contact
        Map<String, Object> toolsCallRequest = Map.of(
            "jsonrpc", "2.0",
            "method", "tools/call",
            "params", Map.of(
                "name", "debt_list_by_contact",
                "arguments", Map.of(
                    "contactId", 123,
                    "page", 1,
                    "limit", 10

...
/**
 * Contract test for gender_get MCP operation.
 * Tests retrieval of specific gender types by ID.
...
public class GenderGetTest {
    ...
    @Test
    void shouldGetGenderViaMcpProtocol() {
        // Given: MCP request to get a specific gender
    ...
    @Test
    void shouldValidateRequiredIdForGender() {

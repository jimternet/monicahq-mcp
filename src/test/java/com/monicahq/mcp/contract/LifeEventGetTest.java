...
/**
 * Contract test for lifeevent_get MCP operation.
 * Tests retrieval of specific life events by ID.
...
public class LifeEventGetTest {
    ...
    @Test
    void shouldGetLifeEventViaMcpProtocol() {
        // Given: MCP request to get a specific life event
    ...
    @Test
    void shouldValidateRequiredIdForLifeEvent() {

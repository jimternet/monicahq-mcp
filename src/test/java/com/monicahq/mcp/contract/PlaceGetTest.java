...
/**
 * Contract test for place_get MCP operation.
 * Tests retrieval of specific places by ID.
...
public class PlaceGetTest {
    ...
    @Test
    void shouldGetPlaceViaMcpProtocol() {
        // Given: MCP request to get a specific place
    ...
    @Test
    void shouldValidateRequiredIdForPlace() {

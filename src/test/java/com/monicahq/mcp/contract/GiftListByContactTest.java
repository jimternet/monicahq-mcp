...
/**
 * Contract test for gift_list_by_contact MCP operation.
 * Tests listing gifts filtered by contact ID.
...
public class GiftListByContactTest {
    ...
    @Test
    void shouldListGiftsByContactViaMcpProtocol() {
        Map<String, Object> toolsCallRequest = Map.of(
            "jsonrpc", "2.0",
            "method", "tools/call",
            "params", Map.of(
                "name", "gift_list_by_contact",

...
/**
 * Contract test for address_list_by_contact MCP operation.
 * Tests listing addresses filtered by contact ID.
...
public class AddressListByContactTest {
    ...
    @Test
    void shouldListAddressesByContactViaMcpProtocol() {
        // Given: MCP request to list addresses for a contact
        Map<String, Object> toolsCallRequest = Map.of(
            "jsonrpc", "2.0",
            "method", "tools/call",
            "params", Map.of(
                "name", "address_list_by_contact",
                "arguments", Map.of(
                    "contactId", 123,
                    "page", 1,
                    "limit", 10

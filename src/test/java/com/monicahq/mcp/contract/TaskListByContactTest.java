...
/**
 * Contract test for task_list_by_contact MCP operation.
 * Tests listing tasks filtered by contact ID.
...
public class TaskListByContactTest {
    ...
    @Test
    void shouldListTasksByContactViaMcpProtocol() {
        Map<String, Object> toolsCallRequest = Map.of(
            "jsonrpc", "2.0",
            "method", "tools/call",
            "params", Map.of(
                "name", "task_list_by_contact",

...
/**
 * Contract test for gender_update MCP operation.
 * Tests updating existing gender types.
...
public class GenderUpdateTest {
    ...
    @Test
    void shouldUpdateGenderViaMcpProtocol() {
        // Given: MCP request to update a gender

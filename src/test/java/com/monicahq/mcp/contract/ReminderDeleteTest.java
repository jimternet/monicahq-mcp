...
public class ReminderDeleteTest {
    ...
    void shouldDeleteReminderViaMcpProtocol() {
        Map<String, Object> mcpRequest = Map.of("jsonrpc", "2.0", "method", "tools/call", "params", Map.of("name", "reminder_delete", "arguments", Map.of("id", 22222)), "id", 1);
    ...
    void shouldValidateDeleteRequiresId() {
        Map<String, Object> mcpRequest = Map.of("jsonrpc", "2.0", "method", "tools/call", "params", Map.of("name", "reminder_delete", "arguments", Map.of()), "id", 2);

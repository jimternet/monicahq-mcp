...
public class TagDeleteTest {
    ...
    void shouldDeleteTagViaMcpProtocol() {
        Map<String, Object> mcpRequest = Map.of("jsonrpc", "2.0", "method", "tools/call", "params", Map.of("name", "tag_delete", "arguments", Map.of("id", 11111)), "id", 1);
    ...
    void shouldValidateDeleteRequiresId() {
        Map<String, Object> mcpRequest = Map.of("jsonrpc", "2.0", "method", "tools/call", "params", Map.of("name", "tag_delete", "arguments", Map.of()), "id", 2);

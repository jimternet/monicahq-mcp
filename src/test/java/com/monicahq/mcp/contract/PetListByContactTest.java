...
/**
 * Contract test for pet_list_by_contact MCP operation.
 * Tests listing pets filtered by contact ID.
...
public class PetListByContactTest {
    ...
    @Test
    void shouldListPetsByContactViaMcpProtocol() {
        Map<String, Object> toolsCallRequest = Map.of(
            "jsonrpc", "2.0",
            "method", "tools/call",
            "params", Map.of(
                "name", "pet_list_by_contact",

...
public class ReminderCreateTest {
    ...
    void shouldValidateCreateRequiresContactId() {
        Map<String, Object> toolsCallRequest = Map.of("jsonrpc", "2.0", "method", "tools/call", "params", Map.of("name", "reminder_create", "arguments", Map.of("title", "No contact ID")), "id", 2);
    ...
    void shouldValidateCreateRequiresTitle() {
        Map<String, Object> toolsCallRequest = Map.of("jsonrpc", "2.0", "method", "tools/call", "params", Map.of("name", "reminder_create", "arguments", Map.of("contactId", 12345, "initialDate", "2025-12-25")), "id", 3);

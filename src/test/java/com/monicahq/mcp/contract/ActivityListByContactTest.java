...
/**
 * Contract test for activity_list_by_contact MCP operation.
 * Tests listing activities filtered by contact ID.
...
public class ActivityListByContactTest {
    ...
    @Test
    void shouldListActivitiesByContactViaMcpProtocol() {
        // Given: MCP request to list activities for a contact
    ...
    void shouldFilterResultsByContactId() {
        ...
        // Note: Actual filtering validation would check that all returned
        // activities have contact_id == 123, but TestMonicaHqClient stub

...
/**
 * Contract test for document_list_by_contact MCP operation.
 * Tests listing documents filtered by contact ID.
...
public class DocumentListByContactTest {
    ...
    @Test
    void shouldListDocumentsByContactViaMcpProtocol() {
        Map<String, Object> toolsCallRequest = Map.of(
            "jsonrpc", "2.0",
            "method", "tools/call",
            "params", Map.of(
                "name", "document_list_by_contact",
    ...
    void shouldValidateRequiredContactIdParameter() {
        Map<String, Object> toolsCallRequest = Map.of(
            ...
            "params", Map.of(
                "name", "document_list_by_contact",
                "arguments", Map.of("page", 1, "limit", 10)
            ),
            "id", 2
        );

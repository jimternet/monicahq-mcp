...
/**
 * Contract test for gender_delete MCP operation.
 * Tests deletion of custom gender types.
...
public class GenderDeleteTest {
    ...
    @Test
    void shouldDeleteGenderViaMcpProtocol() {
        // Given: MCP request to delete a gender

...
/**
 * Contract test for place_delete MCP operation.
 * Tests deletion of places.
...
public class PlaceDeleteTest {
    ...
    @Test
    void shouldDeletePlaceViaMcpProtocol() {
        // Given: MCP request to delete a place

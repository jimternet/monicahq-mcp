...
/**
 * Contract test for photo_list_by_contact MCP operation.
 * Tests listing photos filtered by contact ID.
...
public class PhotoListByContactTest {
    ...
    @Test
    void shouldListPhotosByContactViaMcpProtocol() {
        Map<String, Object> toolsCallRequest = Map.of(
            "jsonrpc", "2.0",
            "method", "tools/call",
            "params", Map.of(
                "name", "photo_list_by_contact",

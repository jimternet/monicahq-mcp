...
/**
 * Contract test for lifeevent_delete MCP operation.
 * Tests deletion of life events.
...
public class LifeEventDeleteTest {
    ...
    @Test
    void shouldDeleteLifeEventViaMcpProtocol() {
        // Given: MCP request to delete a life event

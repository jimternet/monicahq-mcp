...
public class TaskDeleteTest {
    ...
    void shouldDeleteTaskViaMcpProtocol() {
        Map<String, Object> mcpRequest = Map.of("jsonrpc", "2.0", "method", "tools/call", "params", Map.of("name", "task_delete", "arguments", Map.of("id", 78901)), "id", 1);
    ...
    void shouldValidateDeleteRequiresId() {
        Map<String, Object> mcpRequest = Map.of("jsonrpc", "2.0", "method", "tools/call", "params", Map.of("name", "task_delete", "arguments", Map.of()), "id", 2);

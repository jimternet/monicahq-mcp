...
/**
 * Contract test for contactfieldtype_delete MCP operation.
 * Tests deletion of contact field types.
...
public class ContactFieldTypeDeleteTest {
    ...
    @Test
    void shouldDeleteContactFieldTypeViaMcpProtocol() {
        // Given: MCP request to delete contact field type
        Map<String, Object> toolsCallRequest = Map.of(
            "jsonrpc", "2.0",
            "method", "tools/call",
            "params", Map.of(
                "name", "contactfieldtype_delete",
                "arguments", Map.of("id", 88888)
            ),
            "id", 1
        );

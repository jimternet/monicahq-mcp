...
public class TagGetTest {
    ...
    void shouldGetTagByIdViaMcpProtocol() {
        Map<String, Object> mcpRequest = Map.of("jsonrpc", "2.0", "method", "tools/call", "params", Map.of("name", "tag_get", "arguments", Map.of("id", 11111)), "id", 1);
    ...
    void shouldHandleTagNotFound() {
        Map<String, Object> mcpRequest = Map.of("jsonrpc", "2.0", "method", "tools/call", "params", Map.of("name", "tag_get", "arguments", Map.of("id", 99999)), "id", 2);

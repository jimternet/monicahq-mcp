...
/**
 * Contract test for call_list_by_contact MCP operation.
 * Tests listing calls filtered by contact ID.
...
public class CallListByContactTest {
    ...
    @Test
    void shouldListCallsByContactViaMcpProtocol() {
        // Given: MCP request to list calls for a contact
        Map<String, Object> toolsCallRequest = Map.of(
            "jsonrpc", "2.0",
            "method", "tools/call",
            "params", Map.of(
                "name", "call_list_by_contact",
                "arguments", Map.of(
                    "contactId", 123,
                    "page", 1,
                    "limit", 10

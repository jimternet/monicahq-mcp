...
/**
 * Contract test for note_list_by_contact MCP operation.
 * Tests listing notes filtered by contact ID.
...
public class NoteListByContactTest {
    ...
    @Test
    void shouldListNotesByContactViaMcpProtocol() {

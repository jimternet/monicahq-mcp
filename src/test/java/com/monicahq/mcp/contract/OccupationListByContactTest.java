...
/**
 * Contract test for occupation_list_by_contact MCP operation.
 * Tests listing occupations filtered by contact ID.
...
public class OccupationListByContactTest {
    ...
    @Test
    void shouldListOccupationsByContactViaMcpProtocol() {
        Map<String, Object> toolsCallRequest = Map.of(
            "jsonrpc", "2.0",
            "method", "tools/call",
            "params", Map.of(
                "name", "occupation_list_by_contact",

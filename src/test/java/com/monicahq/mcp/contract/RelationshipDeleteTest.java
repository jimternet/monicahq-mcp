...
/**
 * Contract test for relationship_delete MCP operation.
...
public class RelationshipDeleteTest {
    ...
    @Test
    void shouldDeleteRelationshipViaMcpProtocol() throws Exception {
        // Given: TestMonicaHqClient will return stubbed relationship deletion response
        
        // When: Send MCP tools/call request to delete relationship
    ...
    @Test
    void shouldValidateRequiredIdForRelationshipDelete() throws Exception {
